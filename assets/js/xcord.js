        ...
        function n() {
          ...
          function a(e, a) {
            ...
            switch (
              ...
              case "404":
                t.innerHTML =
                  '<span class="discord-error">Geçersiz Sunucu ID</span>';
                break;
              case "522":
                t.innerHTML =
                  '<span class="discord-error">Discord Uyuşmazlık Sorunu</span>';
            }
            ...
            if (a.showAllUsers) {
              p +=
                '<li class="discord-channel discord-allusers-toggle">&#9662; Çevrimiçi Kullanıcılar</li><ul class="discord-userlist discord-allusers">';
            ...
            "null" != e.instant_invite &&
              (g =
                '<a href="' +
                e.instant_invite +
                '" target="_blank">Sunucuya Katıl</a>'),
              (t.innerHTML = p),
              (d.innerHTML = "Çevrimiçi Kullanıcı: " + e.members.length),
